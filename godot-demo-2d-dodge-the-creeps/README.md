...
Language: Kotlin via Kanama

Renderer: Compatibility

This Kanama port keeps the original Godot demo scenes and assets, replacing
the GDScript gameplay files with Kotlin scripts under `kotlin-src/`.
