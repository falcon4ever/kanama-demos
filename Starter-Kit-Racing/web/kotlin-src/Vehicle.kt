...
import net.multigesture.kanama.api.getPhysicsProcessDeltaTime
...
open class Vehicle(godotObject: GodotHandle) : KanamaScript<Node3D>(godotObject, ::Node3D) {
    ...
    open fun physicsProcess(delta: Double) {
        ...
        // Web adaptation: the sphere is physics-driven, so fresh reads ride the
        // global-position immediates (the vertical offset survives Y-rotation).
