# Squash the Creeps (3D) Kanama Port

This is a Kanama Kotlin port of the official Godot demo project.
It is a simple game where your character must move
...
Build the Kotlin scripts with:

```shell
../../kanama/gradlew -p . buildScripts
```

Open the project in Godot after building. The `SmokeQuit` script is only for automated headless smoke tests and exits immediately during normal play.
...
Original Godot demo project code is MIT licensed.
