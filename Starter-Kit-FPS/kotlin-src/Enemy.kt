...
class Enemy(godotObject: GodotHandle) : KanamaScript<Area3D>(godotObject, ::Area3D) {
  ...
  fun onTimerTimeout() {
    ...
    // Portable dispatch: resolve the Kotlin Player instance directly (web generates no
    // <Script>Methods facade); same null-means-no-hit contract as PlayerMethods.damage.
