...
class BeetleBot(godotObject: GodotHandle) :
  ...
  fun ready() {
    ...
    beetleSkin =
      self.requireAs("BeetlebotSkin", ::Node3D).kotlinScriptInstance<BeetlebotSkin>()
  ...
  fun damage(impactPoint: Vector3, force: Vector3) {
    ...
    self.setAxisLock(BodyAxis.ANGULAR_X, false)
    self.setAxisLock(BodyAxis.ANGULAR_Y, false)
    self.setAxisLock(BodyAxis.ANGULAR_Z, false)
